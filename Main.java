...
public class Main {
    public static void main (String[] args) {
        ...
        questions.put("Alcohol Department", new String[]{"Hey, do you guys have any cigs around here? Smokin.", "Hi, it’s date night tonight and my wife wants wine… Wine!", "Take me to the wine department!", "HANDS UP! I've gotta knife here, where are you hiding the red wine?"});

...
public class Main {
    public static void main (String[] args) {
        ...
        questions.put("Books Department", new String[] {"Good morning folks, it’s me Jason, here to search for Chicken Doom, the top book of 1983! Where is it?", "Oooh I just love murder. Where can I find a AH a book about murder?", "Where can I get the latest newspaper?", "Do you guys have the latest Tears of the Kingdom history book?", "Pacman! I love that yellow goober. Where can I get a book about Pacman?", "Do you guys have any manga in stock?", "Can I get a good book for my Sorenson book project and the sparknotes with it", "Hey bum, do you offer this book in e-book format?"});

...
public class Main {
    public static void main (String[] args) {
        ...
        questions.put("Technology Department", new String[]{"Do you, my good friend, know where I can watch Family Guy?", "Where can I get the latest Friday the 13th DVD disc?", "I Scream IV! Where is it?!", "Oy do you know where I can get the Texas Chainsaw Massacre VHS tapes?", "Hi, where can I get Halloween?", "Hot! Hot! Its so hot out there? Do you guys have fans? Where can I get fans?", "It's a government conspiracy here! Aliens are real!", "Hi, so I dropped my phone into the toliet, where can I get a replacement?", "Top of the mornin’ to ya lads, it’s me Jacksepticeye, here to find Lois from Family Guy. Where can I watch Family Guy?", "Where can I find the latest Rizzard game?", "So, my boy’s birthday is coming up next week and he’s expecting a big, expensive, exciting gift. Where can I get the pirated version of Legacy of Zelda on the NES and Nintendo?", "Hi, so my son tossed my computer into the lake off from a 30 story tall skyscraper so um…… where can I get a new computer?"});
        questions.put("Clothing Department", new String[]{"So, my prom dress got ripped, do you have any prom dresses in stock?", "So, my interviewer expects me to like OMG dress up as Santa Claus during the Interview for the special mall Christmas event, where can I get the Jolly Fat Man skin suit?", "Halloween is coming up next week. Do you have any spooky scary costumes?", "So, why didn’t skeleton go to the ball? Because he had no body to go with… Now give me a body! Where can I find a mannequin?", "Excuse me, my interview is tomorrow and I need formal clothing. Where can I find some?"});
